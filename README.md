...
#### 📼 Preview video: [Youtube](https://www.youtube.com/watch?v=BaFidbF3mhA)

With our recent flatbed script release, a lot of requests were made to make a towing script as well, which could be used together. Well, here it is! There is a big focus is synchronization, since this is a common issue for scripts using ropes. Winch functionallity is also included and synchronized.
...
- Many other configurable options, like keybindings, labels, notifications and more.
